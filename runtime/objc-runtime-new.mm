...
static Class realizeClass(Class cls)
{
    ...
    if (strcmp(class_getName(cls), "MyObject") == 0) {
        printf("==MyObject==\n");
        printf("cls object:%x, cls->isa object:%x, cls->object_getclass():%x, cls->object_getclass()->isa:%x\n", cls, cls->ISA(), object_getClass(cls), object_getClass(cls->ISA()));
        printf("==MyObject==\n");
    }
